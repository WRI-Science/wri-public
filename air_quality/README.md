...
## Output
Final raster layers are written under **`{WRI_PROJECT_ROOT}/final_layers/<year>/air_quality/`** (see the repository root [README](../README.md) for configuring `WRI_PROJECT_ROOT`).
