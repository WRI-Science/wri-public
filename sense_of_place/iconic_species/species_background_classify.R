...
species <- rast(file.path(wri_project_root, "final_layers", "2024", "sense_of_place", "iconic_species", "sense_of_place_iconic_species_domain_score.tif"))
...
results <- foreach(i = 1:length(states_vect), .packages = c("terra", "sf")) %dopar% {
  ...
  out_path <- file.path(wri_project_root, "final_layers", "2024", "sense_of_place", "iconic_species", "final_checks", paste0("species_classified_", state_name, ".tif"))
...
out_folder <- file.path(wri_project_root, "final_layers", "2024", "sense_of_place", "iconic_species", "final_checks")
