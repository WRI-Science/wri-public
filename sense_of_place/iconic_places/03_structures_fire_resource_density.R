...
#### Data Layers ####
distance_to_nearest_fire_station <- rast("/home/shares/wwri-wildfire/final_layers/2024/infrastructure/indicators/infrastructure_resistance_fire_resource_density.tif")
