...
natural_habitats_resistance <- rast(file.path(wri_project_root, "final_layers", "2024", "natural_habitats", "natural_habitats_resistance.tif"))
natural_habitats_recovery <- rast(file.path(wri_project_root, "final_layers", "2024", "natural_habitats", "natural_habitats_recovery.tif"))
